<template>
  <footer class="footer" role="footer">
    <img class="background-tree" src="/icons/tree-footer.svg" alt="tree image as decorative background">
    <div class="footer__container max">
      <div class="contact">
        <address>
          <a class="email footer-navbar-item" href="mailto:contact@nashvilleforesttherapy.com">contact@nashvilleforesttherapy.com</a>
    ...
    <div class="rights">
      <p class="has-text-light">
        &copy; {{ getYear }} Nashville Forest Therapy All Rights Reserved
      </p>
    </div>
  </footer>
</template>
